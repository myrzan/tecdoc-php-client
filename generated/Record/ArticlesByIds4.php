...
use Myrzan\TecDocClient\Generated\Record\ArticleDocuments;

/**
 * Class representing ArticlesByIds4
 *
 * 
 * XSD Type: articlesByIds4Record
 */
class ArticlesByIds4 
{
    ...
    /**
     * @var ArticleDocuments[] $articleDocuments
     */
     ...
     * Adds as array
     *
     * @param ArticleDocuments $array
     * @return self
     */
    public function addToArticleDocuments(ArticleDocuments $array)
    {
     ...
     *
     * @param ArticleDocuments[] $articleDocuments
     * @return self
     */
     ...
     * Adds as array
     *
     * @param UsageNumbers $array
     * @return self
     */
    public function addToUsageNumbers(UsageNumbers $array)
    {
     ...
     *
     * @param UsageNumbers[] $usageNumbers
     * @return self
     */
