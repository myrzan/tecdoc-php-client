 ...
 */
class AssemblyGroupFacetCounts
{
    ...
    /**
     * @var AssemblyGroupFacetCount[] $counts
     */
    private $counts = [
     ...
     * Adds as counts
     *
     * @param AssemblyGroupFacetCount $counts
     * @return self
     */
    public function addToCounts(AssemblyGroupFacetCount $counts)
    {
        $this->counts[] = $counts;
        return $this;
    }
     ...
     * Gets as counts
     *
     * @return AssemblyGroupFacetCount[]
     */
