...
use Myrzan\TecDocClient\Generated\Record\ArticleDirectSearchById4;
use Myrzan\TecDocClient\Generated\Record\ArticleDocuments2;

/**
 * Class representing ArticlesByIds7
 *
 * 
 * XSD Type: articlesByIds7Record
 */
class ArticlesByIds7
{
    ...
    /**
     * @var AssignedArticleById4 $assignedArticle
     */
    private $assignedArticle = null;

    /**
     * @var ArticleDirectSearchById4 $directArticle
     */
     ...
     *
     * @param AssignedArticleById4 $assignedArticle
     * @return self
     */
    public function setAssignedArticle(AssignedArticleById4 $assignedArticle)
    {
     ...
     *
     * @return ArticleDirectSearchById4
     */
     ...
     *
     * @param ArticleDirectSearchById4 $directArticle
     * @return self
     */
    public function setDirectArticle(ArticleDirectSearchById4 $directArticle)
    {
