...
/**
 * Class representing DirectArticlesByIds4RequestType
 *
 * 
 * XSD Type: directArticlesByIds4Request
 */
class DirectArticlesByIds4RequestType extends DirectArticlesByIds4RequestSrcType
{
     ...
     * @param int $array
     */
    public function addToArticleId($array)
    {
     ...
     * @return bool
     */
    public function issetArticleId($index)
    {
        return isset($this->articleId[$index]);
    }
     ...
     * @return void
     */
    public function unsetArticleId($index)
    {
        unset($this->articleId[$index]);
    }
